...
class PyAction:
    def __init__(self):
        ...
        # 画像のロード
        megaman.right_image = load_image("d:/work/pygame/jump/data/megaman.png", -1)                     # 左向き
        megaman.left_image = pygame.transform.flip(megaman.right_image, 1, 0)  # 右向き
        
        # オブジェクとグループと蛇の作成
        self.all = pygame.sprite.RenderUpdates()
        megaman.containers = self.all
        megaman()
