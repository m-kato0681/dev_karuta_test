    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                ...
                <button type="button" class="btn btn-danger" onclick="confirmVoting()" data-bs-dismiss="modal">はい</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="alertModal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center">
                <label>
                    <i class="alert-text fas fa-exclamation-triangle">2票以上投票してください。</i>
                </label>
            </div>
        </div>
    </div>
...
<!-- 不正投票警告用モーダルの設定 -->
<div class="modal fade" id="banModal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center">
                <label>
                    <i class="alert-text fas fa-exclamation-triangle">前回の投票から24時間が経過していないため<br>投票を完了することができません。</i>
                </label>
            </div>
        </div>
    </div>
