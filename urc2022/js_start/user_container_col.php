<!-- 1ユーザーの表示単位 -->
<div id=<?php echo "col".$id_num; ?> class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 mt-2 mb-4">
    <!-- モーダルボタン(サムネイル) -->
    ...
    <!-- 投票or投票取り消しボタン -->
    <div class="voting">
        <img id=<?php echo "votingBtn".$id_num; ?> onclick="changeBtnImg(this.id)" src="images/votingbtn_vote.png" class="d-block mx-auto img-fluid w-40 mt-1">
    </div>
    <!-- 表示タイトル -->
